...
function Car(make, model, year, color){
  ...
  this.color= color;
  // this.drive= function (){
  //   console.log(`You drive the ${this.model}`) //template string
  // }
}
...
const car2= new Car("Renault", "Le Car", 1988, "silver");
const car3= new Car("Dodge", "Charger", 1972, "pea green");
...
// Prototyple Inheritance --> Move the method OUTSIDE the Constructor function 
